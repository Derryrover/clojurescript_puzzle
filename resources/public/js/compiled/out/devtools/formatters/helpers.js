...
var G__52494 = devtools.prefs.pref.call(null,v);
v = G__52494;
continue;
} else {
return v;
...
var and__25927__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25927__auto__){
var and__25927__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25939__auto__ = (function (){try{if(!((value == null))){
...
}catch (e52507){var e__37370__auto__ = e52507;
return false;
}})();
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
var or__25939__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e52511){var e__37370__auto__ = e52511;
return false;
}})();
...
}catch (e52513){var e__37370__auto__ = e52513;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25927__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25927__auto__)){
var and__25927__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25927__auto____$1){
...
var and__25927__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25927__auto__)){
...
var or__25939__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
...
var and__25927__auto__ = (function (){var or__25939__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
...
var vec__52518 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__52518,(0),null);
var name = cljs.core.nth.call(null,vec__52518,(1),null);
...
var and__25927__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25927__auto__)){
...
var or__25939__auto__ = typeof value === 'string';
if(or__25939__auto__){
return or__25939__auto__;
} else {
var or__25939__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__52521_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__52521_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1496347457957