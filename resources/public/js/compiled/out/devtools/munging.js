...
var temp__4657__auto____$1 = goog.object.get(o__37358__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37357__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37357__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__37345__auto__ = f;
return goog.object.get(o__37345__auto__,"toString").call(o__37345__auto__);
}catch (e52348){var _ = e52348;
return "";
}});
...
try{var o__37345__auto___52351 = t;
goog.object.get(o__37345__auto___52351,"cljs$lang$ctorPrWriter").call(o__37345__auto___52351,t,writer);
}catch (e52350){var __52352 = e52350;
}
...
var char_code = (function (){var o__37345__auto__ = (new String(char$));
return goog.object.get(o__37345__auto__,"charCodeAt").call(o__37345__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37345__auto__ = String;
return goog.object.get(o__37345__auto__,"fromCharCode").call(o__37345__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__52354 = num_code;
switch (G__52354) {
case (1):
return (185);
...
var o__37345__auto__ = String;
return goog.object.get(o__37345__auto__,"fromCharCode").call(o__37345__auto__,superscript_code);
});
/**
...
}catch (e52360){var e__37370__auto__ = e52360;
return false;
}})())){
...
var vec__52361 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__52361,(0),null);
...
var or__25939__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__37358__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__37358__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37357__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37357__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27014__auto___52370 = arguments.length;
var i__27015__auto___52371 = (0);
while(true){
if((i__27015__auto___52371 < len__27014__auto___52370)){
args__27021__auto__.push((arguments[i__27015__auto___52371]));

var G__52372 = (i__27015__auto___52371 + (1));
i__27015__auto___52371 = G__52372;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27022__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__52366){
var vec__52367 = p__52366;
var ns_detector = cljs.core.nth.call(null,vec__52367,(0),null);
var effective_detector = (function (){var or__25939__auto__ = ns_detector;
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
...
var G__52373 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__52374 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__52373;
remaining_tokens = G__52374;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq52364){
var G__52365 = cljs.core.first.call(null,seq52364);
var seq52364__$1 = cljs.core.next.call(null,seq52364);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__52365,seq52364__$1);
});
...
var vec__52382 = cljs.core.split_with.call(null,(function (p1__52378_SHARP_){
return cljs.core.not_EQ_.call(null,p1__52378_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__52382,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__52382,(1),null);
...
var vec__52388 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__52388,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__52388,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__52391 = cljs.core.rest.call(null,remaining_tokens);
var G__52392 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__52391;
name_tokens = G__52392;
continue;
} else {
...
var args52393 = [];
var len__27014__auto___52405 = arguments.length;
var i__27015__auto___52406 = (0);
while(true){
if((i__27015__auto___52406 < len__27014__auto___52405)){
args52393.push((arguments[i__27015__auto___52406]));

var G__52407 = (i__27015__auto___52406 + (1));
i__27015__auto___52406 = G__52407;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args52393.length)].join('')));
...
var vec__52396 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__52396,(0),null);
var arity = cljs.core.nth.call(null,vec__52396,(1),null);
var vec__52399 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__52399,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__52399,(1),null);
var vec__52402 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__52402,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__52402,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__52402,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__52402,(3),null);
...
var args52409 = [];
var len__27014__auto___52415 = arguments.length;
var i__27015__auto___52416 = (0);
while(true){
if((i__27015__auto___52416 < len__27014__auto___52415)){
args52409.push((arguments[i__27015__auto___52416]));

var G__52417 = (i__27015__auto___52416 + (1));
i__27015__auto___52416 = G__52417;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args52409.length)].join('')));
...
var vec__52412 = result;
var munged_ns = cljs.core.nth.call(null,vec__52412,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__52412,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__52412,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__52412,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__52412,(4),null);
var arity = cljs.core.nth.call(null,vec__52412,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__52425 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__52425,(0),null);
var args = cljs.core.nth.call(null,vec__52425,(1),null);
var vec__52428 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__52428,(0),null);
var name = cljs.core.nth.call(null,vec__52428,(1),null);
...
var G__52431 = (arity + (1));
var G__52432 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__52433){
var vec__52437 = p__52433;
var arity = cljs.core.nth.call(null,vec__52437,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__52437,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__25939__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__52440_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__52441_SHARP_);
...
var args__27021__auto__ = [];
var len__27014__auto___52448 = arguments.length;
var i__27015__auto___52449 = (0);
while(true){
if((i__27015__auto___52449 < len__27014__auto___52448)){
args__27021__auto__.push((arguments[i__27015__auto___52449]));

var G__52450 = (i__27015__auto___52449 + (1));
i__27015__auto___52449 = G__52450;
continue;
} else {
}
break;
...
var argseq__27022__auto__ = ((((1) < args__27021__auto__.length))?(new cljs.core.IndexedSeq(args__27021__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27022__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__52444){
var vec__52445 = p__52444;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__52445,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq52442){
var G__52443 = cljs.core.first.call(null,seq52442);
var seq52442__$1 = cljs.core.next.call(null,seq52442);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__52443,seq52442__$1);
});
...
var G__52452 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__52452) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__25939__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__25927__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__25939__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
...
var map__52459 = options;
var map__52459__$1 = ((((!((map__52459 == null)))?((((map__52459.cljs$lang$protocol_mask$partition0$ & (64))) || (map__52459.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52459):map__52459);
var include_ns_QMARK_ = cljs.core.get.call(null,map__52459__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__52459__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__52459__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__52459__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__52460 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__52460,(0),null);
var fn_name = cljs.core.nth.call(null,vec__52460,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__52460,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__52460,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__52460,(4),null);
var arity = cljs.core.nth.call(null,vec__52460,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__25927__auto__ = protocol_ns;
if(cljs.core.truth_(and__25927__auto__)){
return cljs.core.not.call(null,(function (){var and__25927__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__25939__auto__ = protocol_part;
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
return fn_part;
...
var o__37345__auto__ = f;
return goog.object.get(o__37345__auto__,"getBasis").call(o__37345__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__25927__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25927__auto__)){
...
}catch (e52465){var e__37370__auto__ = e52465;
...
var G__52466 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__52467 = cljs.core.rest.call(null,path);
obj = G__52466;
path = G__52467;
continue;
} else {
...
var partition_bits = (function (){var or__25939__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__25939__auto__)){
return or__25939__auto__;
} else {
return (0);
...
return (function (accum,p__52472){
var vec__52473 = p__52472;
var bit = cljs.core.nth.call(null,vec__52473,(0),null);
var protocol = cljs.core.nth.call(null,vec__52473,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__52476){
var vec__52480 = p__52476;
var ns = cljs.core.nth.call(null,vec__52480,(0),null);
var name = cljs.core.nth.call(null,vec__52480,(1),null);
var selector = cljs.core.nth.call(null,vec__52480,(2),null);
...
return (function (p__52488){
var vec__52489 = p__52488;
var munged_name = cljs.core.nth.call(null,vec__52489,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__52489,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__52489,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__52483_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__52483_SHARP_));
});})(name,sorted_matches,vec__52489,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1496347457535