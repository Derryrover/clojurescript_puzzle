...
return cljs.core.reduce.call(null,(function (result,p__52272){
var vec__52273 = p__52272;
var k = cljs.core.nth.call(null,vec__52273,(0),null);
var v = cljs.core.nth.call(null,vec__52273,(1),null);
...
var vec__52279 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__52279,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__52279,(1),null);
var ab = cljs.core.nth.call(null,vec__52279,(2),null);
...
var args52282 = [];
var len__27014__auto___52285 = arguments.length;
var i__27015__auto___52286 = (0);
while(true){
if((i__27015__auto___52286 < len__27014__auto___52285)){
args52282.push((arguments[i__27015__auto___52286]));

var G__52287 = (i__27015__auto___52286 + (1));
i__27015__auto___52286 = G__52287;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args52282.length)].join('')));
...
var x__26602__auto__ = (((x == null))?null:x);
var m__26603__auto__ = (clojure.data.equality_partition[goog.typeOf(x__26602__auto__)]);
if(!((m__26603__auto__ == null))){
return m__26603__auto__.call(null,x);
} else {
var m__26603__auto____$1 = (clojure.data.equality_partition["_"]);
if(!((m__26603__auto____$1 == null))){
return m__26603__auto____$1.call(null,x);
} else {
...
var x__26602__auto__ = (((a == null))?null:a);
var m__26603__auto__ = (clojure.data.diff_similar[goog.typeOf(x__26602__auto__)]);
if(!((m__26603__auto__ == null))){
return m__26603__auto__.call(null,a,b);
} else {
var m__26603__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__26603__auto____$1 == null))){
return m__26603__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__52292 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__52292) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1496347456863